    ...
    <section>
        <div class="content">
            <div class="steps-box">
                ...
                <div class="steps">
                    <img src = "assets/Blue Line.png" alt = "Blue Line" class = "line">
                    <br><br><br><br>
                </div>  
                <div class="steps">
                    <img src = "assets/Blue Mark.png" alt = "Blue Mark" class = "imgs">
        ...
        <div class="content-2">
            <div class = "requirement-box">
                <div class = "top-section">
                    <a class = "back-button" href="enrollmentTracker.php"> 
                ...
                <div class ="bottom-section">
                    ...
                    <div class = "requirements4" style="background: #FFC7C7;">
                        <img src = "assets/goodMoral.png" alt = "Good Moral" class = "reqImages">
                            ...
                            <p>You can get this on your previous Kindergarten.</p>
                    </div>
                </div>
                <div class="bottom-text">Pls!, Pass this Document During Working Days.</div>
            </div>
        </div>
    </section>
    <footer>
